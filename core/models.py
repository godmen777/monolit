...
class Service(MPTTModel):
    ...
    slogan = models.CharField(u'Слоган', max_length=200, unique=False)
    icon = models.CharField(max_length=200, verbose_name=u"Иконка для услуги")
...
class Post(models.Model):
    ...
    icon = models.CharField(max_length=200, verbose_name=u"Иконка для статьи", help_text=u'пример: <i class="icon-our-service icon-house_sell"></i>')
    image = models.ImageField(upload_to="services")
